...
```{r}
   ...
   kable(fu_separated) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(fu_tidy) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(fu_team) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(fu_city) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(fu_england) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(fu_tidy2) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
  ...
  kable(fu1) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(fu2) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(fu3) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
