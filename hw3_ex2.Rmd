...
kable(longevity, caption = "Longevity in 2016") %>% kable_styling() %>% scroll_box(width = "900px", height = "300px") #output the data cleaning in a scroll box
...
kable(ea_na_75_85, "East Asian and North American countries with life expectancies between 75 and 85") %>% kable_styling() %>% scroll_box(width = "900px", height = "300px") #output the data cleaning in a scroll box
...
kable(top_10_perc_us, caption = "Top 10 percent in life expectany and the US") %>% kable_styling() %>% scroll_box(width = "900px", height = "300px") #output the data cleaning in a scroll box
...
kable(gdp_by_region, caption = "GDP by region") %>% kable_styling() %>% scroll_box(width = "900px", height = "300px") #output the data cleaning in a scroll box
...
kable(p_countries, "simple",  caption = "Proportion of countries with life expectancy over 70 by income category") #show output in the html
...
nations %>%
   ...
   geom_hline(aes(yintercept = median(life_expect, na.rm = T)),   # Ignore NA values for mean
               color = "red", size = 0.5) +
...
nations %>%
   ...
   facet_wrap(~ region, scales='free') + #divide a graphic into several panels, corresponding to the region difference
