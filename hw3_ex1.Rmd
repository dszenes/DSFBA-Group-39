...
kable(length_sex_ring) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(filter_na) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(transmute_abalone) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(first_1000_rank) %>% kable_styling() %>% scroll_box(width = "900px", height = "300px")
...
```{r}
   ...
   kable(n_distinct_rings_by_sex, "simple")
