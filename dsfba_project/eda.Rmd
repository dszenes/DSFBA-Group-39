...
ggplot(biggest_neighborhoods,
  ...
  geom_bar(stat = "identity", fill = "#2b8cbe") + theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = .5))
...
scale_fill_brewer(palette = "Blues") + theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = .5))
