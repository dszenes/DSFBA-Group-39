...
```
_Source of the data set:_ [https://catalog-next.data.gov/dataset/covid-19-cases-and-deaths-summarized-by-geography]
...
```
_Source of the data set:_ [https://data.sfgov.org/COVID-19/COVID-19-Cases-Summarized-by-Date-Transmission-and/tvq9-ec9w]
...
demostats_2016geo <-
  bind_cols(violent_crime_2016_neighborhood,
            crime_2016_neighborhood,
            demostats_2016, neigh)
#no need of extra-cleaning: we just want the socio-demographic column and the geometry one.
