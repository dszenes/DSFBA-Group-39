...
* We will focus on these variables:`Incident Datetime`, `Incident Date`, `Incident Time`, `Incident Year`, `Incident Day of Week`, `Incident Category`, `Resolution`, `Analysis Neighborhood`, `Latitude`, `Longitude`, `point`.
