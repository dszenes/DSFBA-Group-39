...
c1 <- crime_demostats_2016geo$geometry %>% ggplot() + geom_sf(aes(fill = crime_demostats_2016geo$`Non-Family Households`)) + scale_fill_gradient(low = "#56B1F7", high = "#132B43") + xlab("Longitude") + ylab("Latitude") + labs(title = "Non-Family households in neighborhood", fill = "Number Non-Family Households") 
